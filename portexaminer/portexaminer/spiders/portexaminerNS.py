...
class PortExaminerSpider(Spider):
    ...
    def parse(self, response):
        ...
        #Calls only categories N-S to split result URL's between 5 concurrent spiders#
        result_urls = result_urls[13:19]
    ...
    def parse_shipment_page(self, response):
        ...
        n_name = response.xpath('//*[@id="wrapper"]/section/article[6]/div[2]/div[1]/table/tr[1]/td[2]//text()').extract_first().strip()
        n_address = response.xpath('//*[@id="wrapper"]/section/article[6]/div[2]/div[1]/table/tr[2]/td[2]//text()').extract_first().strip()
